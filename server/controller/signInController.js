...
module.exports = {
    ...
    debug: function(req, res) {
        ...
        // console.log(db.profiles.data[0])
    },
    update: function(req, res){
        ...
        // db.profiles.data[profileIndex].push({thumbnail, about});
    ...
    fetchPost: function(req, res){
        ...
        if(req.query.comments==="true"){
            console.log("comment")
            const commentIndex = db.comments.data.map(val => {
        ...
        }else if(req.query.comments==="false"){
            console.log("post")
            res.status(200).json(db.posts.data[postIndex])
